...
<h2 class='py-3'><span class='badge badge-pill badge-primary'>1</span> Должностная инструкция</h2>
        ...
        <div class='card mb-2'>
          <div class='card-header' id='headingOne'>
            ...
            <div style = 'display: flex; flex-wrap: wrap; justify-content: space-between;'>
              ...
              <p align = 'right' style = 'margin-top: auto; font-size:12px'>Ред.</p>
 ...
 5. Требовать от руководства предприятия оказания содействия в исполнении им его должностных обязанностей и прав.
	...
	<p><a name='Техника безопасности'></a></p>
