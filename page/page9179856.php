...
<?php echo file_get_contents('../generation_instruction_page_parts/header555_2.php', FALSE, NULL); ?>
...
<b>Наименование документа:</b> <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M18 0H2C0.9 0 0.00999999 0.9 0.00999999 2L0 20L4 16H18C19.1 16 20 15.1 20 14V2C20 0.9 19.1 0 18 0ZM16 12H4V10H16V12ZM16 9H4V7H16V9ZM16 6H4V4H16V6Z" fill="#40BC63"/> </svg>  <br/> 
<b>Вид документа:</b>  <br/> 
<b>Должностная инструкция:</b>  <br/> 
<b>Оглавление:</b>  <br/> 
<b>Комментарии:</b>  <br/> 
...
<h2 class='py-3'><span class='badge badge-pill badge-primary'>1</span> Должностные инструкции</h2>
    ...
    <div class='alert alert-warning mb-5' role='alert'><b>Должностная инструкция разработана в соответствии:</b> </div>
