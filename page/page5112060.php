          ...
          <div class='card-header' id='headingOne'>
            ...
            <div style = 'display: flex; flex-wrap: wrap; justify-content: space-between;'>
              ...
              <button class='btn btn-link' data-toggle='collapse' name = 'mainst' data-target='#collapseOne' aria-expanded='true' aria-controls='collapseOne'>
                ...
                <a style='color: #525050' id = 'insertAffiliation' class = 'lk_field'>I. Общие положения</a>
              </button>
                            ...
                            if (document.getElementById(edit_element).innerHTML == 'Ред.') {
                                ...
                                if(user_property != ''){
                                    ...
                                    $.ajax({
                                        ...
                                        data: {user_property: user_property, insert_element: insert_element, page: <?php echo 5112060; ?>},
                                        dataType: 'json',
                                        success: callback
                                    });
